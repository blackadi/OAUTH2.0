...
| `03-curriculum-audit.md` citing `PROGRESS.md:1401` for the RFC 8446 verification claim | Wrong **when written** — it matched no revision of the file. Correct target `PROGRESS.md:2051-2052` | fixed 2026-08-11 during T0-6; see `04-remediation-plan.md` §6.3 |
