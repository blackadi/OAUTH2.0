...
silent renewal is impossible and the failure is unattributable. `PROGRESS.md:392-393` puts it well — *"breaks
...
`PROGRESS.md:930` records this as *"flagged as a Module 07 report item rather than a Module 08 finding"*, which
