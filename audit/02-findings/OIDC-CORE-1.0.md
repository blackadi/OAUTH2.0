...
silent renewal is impossible and the failure is unattributable. `PROGRESS.md:815-816` puts it well — *"breaks
...
`PROGRESS.md:1365` records this as *"flagged as a Module 07 report item rather than a Module 08 finding"*, which
