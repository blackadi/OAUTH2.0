...
silent renewal is impossible and the failure is unattributable. `PROGRESS.md:1250-1251` puts it well — *"breaks
...
`PROGRESS.md:1800` records this as *"flagged as a Module 07 report item rather than a Module 08 finding"*, which
