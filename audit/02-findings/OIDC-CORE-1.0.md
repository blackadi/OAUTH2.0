...
silent renewal is impossible and the failure is unattributable. `PROGRESS.md:667-668` puts it well — *"breaks
...
`PROGRESS.md:1213` records this as *"flagged as a Module 07 report item rather than a Module 08 finding"*, which
