...
> (= EH-W1). ~~**FAPI2-W3/W4/W5/W6 remain open**~~ → **W3, W4 and W6 have since shipped (2026-08-13/14); only
> W5 (the Gate 4 "is this a claim we make" decision) is still open.** `getStatus` reports all eight §5.3.2.1
