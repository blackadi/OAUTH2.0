...
- enables the **password** grant (`PASSWORD`; RFC 9700 §2.4 MUST NOT, removed in OAuth 2.1) — and `PROGRESS.md:1873-1874` records a live transcript issuing a 24-hour access token and a 10-day refresh token from it;
