...
| FCL-W2 | Date the `SPEC-INVENTORY.md` row | S | **12 September 2022**, and the *(see note)* qualifier for this row removed. |
| FCL-W3 | Fix the row's implementation column | S | Reads "not implemented" rather than "logout routes". |
