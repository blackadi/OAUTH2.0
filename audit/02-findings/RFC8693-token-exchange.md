...
| 8693-W3 | Fix the stale line numbers in `AGENTS.md` and Part 12 | S | `:47-52`, `:66-76`, `:32`. Consider anchoring on the ⚠️ comment text instead of line numbers, since these have now drifted once. |
