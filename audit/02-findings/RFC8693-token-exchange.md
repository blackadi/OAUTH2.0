...
| 8693-W5 | *(Optional, Gate 4 decision)* Forward `resources` and pass `accessTokenDuration` | M | ✅ **RULED 2026-08-14 (DR-10) — NOT approved; keep all three deliberate defects as-is.** Module 06 Exercise 6b stays intact. See `05-decision-records.md` DR-10. |
