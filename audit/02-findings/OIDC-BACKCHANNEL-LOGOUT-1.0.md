...
when the `issuer` and `audience` options are passed, and they are not. `PROGRESS.md:1466-1467` states this exactly:
...
`PROGRESS.md:1462-1467` records this with the server log confirming the real cause
...
| Back-channel logout receipt cannot work (`JWKS_URI` unset), misreports why, and never checks `iss`/`aud` | `PROGRESS.md:1462-1467` | Confirmed line by line | **Accurate** |
...
- Repo-sourced live evidence: `PROGRESS.md:1462-1467`
