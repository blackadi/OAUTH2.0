...
| 4 | **Exact** `redirect_uri` matching against pre-registered URIs | Authlete's, and verified: the authorization endpoint rejects a non-matching URI with 400 and no `Location` (`PROGRESS.md:1451-1452`) | ✅ |
...
- Repo-sourced live evidence: `PROGRESS.md:1451-1452` (exact redirect-URI matching at the authorization endpoint), `modules/08…/lab.md:94-107,148-173` (`sub` in the ID token)
