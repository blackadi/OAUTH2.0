...
| `authorizationCodeDuration: 0` | "NOT EVIDENCED" — `PROGRESS.md:1793` | **`0`** — confirmed |
...
4. **`introspection_endpoint_auth_methods_supported` is an empty array** — independent corroboration of the unauthenticated-introspection finding in B2, and the *"three-source divergence"* `PROGRESS.md:2020-2023` records for revocation.
