...
| `authorizationCodeDuration: 0` | "NOT EVIDENCED" — `PROGRESS.md:1388` | **`0`** — confirmed |
...
4. **`introspection_endpoint_auth_methods_supported` is an empty array** — independent corroboration of the unauthenticated-introspection finding in B2, and the *"three-source divergence"* `PROGRESS.md:1615-1618` records for revocation.
