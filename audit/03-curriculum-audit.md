...
absent on this service (probe 1 §3.4), and `PROGRESS.md:1938-1939` records the live success transcript. Neither
...
3. **The curriculum does not follow the instruction.** `modules/00…/README.md:87` and `:250` still cite RFC
   8446, and `PROGRESS.md:2282-2283` records RFC 8446 as *"verified against primary sources"*. So `SPEC-INVENTORY.md`
...
(**RPL-W1**), and reality disagreed with both: the "one-line fix" framing appears in `PROGRESS.md:1446-1461`, in
