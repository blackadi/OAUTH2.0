...
absent on this service (probe 1 §3.4), and `PROGRESS.md:1533-1534` records the live success transcript. Neither
...
3. **The curriculum does not follow the instruction.** `modules/00…/README.md:87` and `:250` still cite RFC
   8446, and `PROGRESS.md:1877-1878` records RFC 8446 as *"verified against primary sources"*. So `SPEC-INVENTORY.md`
...
(**RPL-W1**), and reality disagreed with both: the "one-line fix" framing appears in `PROGRESS.md:1041-1056`, in
